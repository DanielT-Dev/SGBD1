...
public class MainController {
    ...
    private void setupAllItemsTable() {
        ...
        sellerCol.setCellValueFactory(cell ->
                new SimpleIntegerProperty(
                        cell.getValue().getSeller() != null
                                ? cell.getValue().getSeller().getId()
                                : 0
                ).asObject()
        );
    ...
    private void setupTransactionTable() {
        ...
        buyerCol.setCellValueFactory(cell ->
                new SimpleIntegerProperty(
                        cell.getValue().getBuyer() != null
                                ? cell.getValue().getBuyer().getId()
                                : 0
                ).asObject()
        );
        ...
        itemCol.setCellValueFactory(cell ->
                new SimpleIntegerProperty(
                        cell.getValue().getItem() != null
                                ? cell.getValue().getItem().getId()
                                : 0
                ).asObject()
        );
